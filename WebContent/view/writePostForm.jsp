...
<header class="header_area">
	...
	<form id="join-form" action="write.do" method="POST">
  <div class="form-group">
    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="제목" name="title">
    <c:if test="${errors.titleEmpty}"><span style="color:red;">제목을 입력하세요</span></c:if>
  </div>
  
  <div class="form-group">
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="30" cols="100"name="content" placeholder="내용"></textarea>
  </div>
